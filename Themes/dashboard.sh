...
# status
#rm -rf /root/status
#wget -q -O /root/status "https://raw.githubusercontent.com/tanilink/stunnelvpn-1-1/momok/statushariini" 
clear
...
#update
#wget -q -O updatsc.sh "https://raw.githubusercontent.com/tanilink/stunnelvpn-1/momok/menu/updateyes.sh" && chmod +x updatsc.sh && ./updatsc.sh 
